...
public class BasicExtentReport {
    ...
    public void startReport(String OS, String browser) {
        ...
        extent.setSystemInfo("Automation Tester", "Asim");
        extent.setSystemInfo("Organisation", "CNS");
    ...
    public void ChooseAhmedabad() {
        ...
        Reporter.log("AhmadAbad Location is selected");
        test.info("Executed By Asim");
    }
    ...
    public void SelectMargheritaPiza() throws InterruptedException {
        ...
        Reporter.log("Margherita Piza is selected and location Ahmand abad is confirmed");
    }
    @AfterTest
